...
| Enter event held until the visit closes | Short visits emit nothing, so downstream never has to retract | Enter events arrive with the exit: a whole visit late, plus `lost_ms` when the track was lost |
